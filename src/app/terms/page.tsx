...
export const metadata: Metadata = {
  ...
  description: "AuditWave Terms & Conditions — rules and guidelines for using our website audit tool.",
      ...
      <div className="mx-auto max-w-3xl px-6 py-20">
        ...
        <div className="prose prose-invert prose-slate max-w-none space-y-8 text-slate-300 text-sm leading-relaxed">
          <section>
            ...
            <p>
              By accessing or using AuditWave (&quot;the Service&quot;), available at auditwave.dev, you agree to be bound by these Terms &amp; Conditions. If you do not agree to these terms, you must not use the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              AuditWave is a free website audit tool that provides accessibility, performance, and SEO analysis. The Service uses automated tools including Playwright, axe-core, and Lighthouse to scan websites you submit and generates reports based on the scan results.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              When you submit a URL, AuditWave will load the target webpage using automated browsers and perform various audits. You acknowledge that:
            </p>
            <ul className="list-disc pl-5 space-y-1 mt-2">
              ...
              <li>AuditWave is not responsible for any impact on target websites during scanning</li>
          ...
          <section>
            ...
            <p>
              The Service, including its design, code, logos, and content, is owned by AuditWave and protected by intellectual property laws. You may not copy, modify, or distribute any part of the Service without prior written consent.
            </p>
            <p className="mt-2">
          ...
          <section>
            ...
            <p>
              TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, AUDITWAVE SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, RESULTING FROM: (A) YOUR USE OR INABILITY TO USE THE SERVICE; (B) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SERVERS; (C) ANY INTERRUPTION OR CESSATION OF THE SERVICE; (D) ANY ERRORS OR INACCURACIES IN SCAN RESULTS.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You agree to indemnify and hold harmless AuditWave and its affiliates, officers, agents, and employees from any claim or demand, including reasonable attorneys&apos; fees, arising out of your use of the Service, your violation of these Terms, or your violation of any third-party rights.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:legal@auditwave.dev" className="text-emerald-400 hover:underline">
                legal@auditwave.dev
              </a>.
            </p>
          </section>
